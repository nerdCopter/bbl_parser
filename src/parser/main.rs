...
pub fn parse_single_log(
    ...
    let (mut stats, frames, debug_frames, gps_coordinates, home_coordinates, event_frames) =
        crate::parser::frame::parse_frames(binary_data, &header, debug, export_options)?;
